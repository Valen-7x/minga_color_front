...
export default function NotAllowed() {
  return (
    <div className='flex flex-col justify-center items-center  gap-10 w-screen h-screen bg-[black]'>
...
<Anchor to="/signin"
              ...
              <Anchor to={'/'} type="submit" className="w-[40vh]  bg-[blue] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" >Home</Anchor>
    </div>
  );
}